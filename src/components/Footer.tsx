...
export default function Footer() {
  ...
  const setDarkMode = useCallback((on: boolean, skipStorage: boolean = false) => {
    ...
    styleObj.setProperty("--color-fg", on ? "#e4dbcd" : "#33403d");
    styleObj.setProperty("--color-bg", on ? "#33403d" : "#e4dbcd");
    styleObj.setProperty("--color-bg-alt", on ? "#56625e" : "#bbb5aa");
  ...
  return (
    <footer className="flex justify-between items-center flex-wrap pt-8 pb-16 px-[5%]">
      ...
      <ul className="m-0 mb-12 md:mb-0 p-0 list-none text-center order-1 md:order-2">
        <li className="inline-block mr-8 mb-6 leading-normal last:mr-0">
          ...
          >
            <span className="sr-only">View me on Instagram</span>
        ...
        <li className="inline-block mr-8 mb-6 leading-normal last:mr-0">
          <a
            ...
            className="text-2xl text-foreground shadow-none transition-opacity duration-200 hover:opacity-80 focus:opacity-80 focus-visible:outline-dotted focus-visible:outline-1 focus-visible:outline-foreground [&_svg]:w-[22px] [&_svg]:h-[22px]"
          >
            <span className="sr-only">View me on BlueSky</span>
        ...
        <li className="inline-block mr-8 mb-6 leading-normal last:mr-0">
          <a
            ...
            className="text-2xl text-foreground shadow-none transition-opacity duration-200 hover:opacity-80 focus:opacity-80 focus-visible:outline-dotted focus-visible:outline-1 focus-visible:outline-foreground [&_svg]:w-[22px] [&_svg]:h-[22px]"
          >
            <span className="sr-only">View me on Github</span>
            <Icon svg={GithubIcon} />
          </a>
        </li>
        <li className="inline-block mr-8 mb-6 leading-normal last:mr-0">
        ...
        <li className="inline-block mr-8 mb-6 leading-normal last:mr-0">
          <a
            ...
            className="text-2xl text-foreground shadow-none transition-opacity duration-200 hover:opacity-80 focus:opacity-80 focus-visible:outline-dotted focus-visible:outline-1 focus-visible:outline-foreground [&_svg]:w-[22px] [&_svg]:h-[22px]"
          >
            <span className="sr-only">Rowengartner</span>
